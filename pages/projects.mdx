...
Build in a 12 hour marathon, this app will let you switch your audio output between two options very quickly by double clicking the app icon in the tray.  Download and try it today!
You can download it here: [AudioSwitcher](applications/AudioSwitcher.msi)

---

## Bowling Ball Holder with Nameplate
<Image
    src="/images/ball-holder-with-name.jpg"
    alt="Alpha Ball Holder with Name"
    width={1440}
    height={1084}
    priority
...
Created this fully customizable OpenSCAD of a bowling ball holder that can have text put on it! You can change the text, text, depth. Make the text inny or outty. Change the wall thickness, holder height, lip size, and more!
