...
IMAGE TO COME.
Created this massively customizable bowling ball holder in OpenSCAD. If you didn't know, OpenSCAD uses a custom scripting language to produce 3D graphics.  The scripting language supports functional programming, parametrized modularization and reuse, and mathematical computation. Variables are scoped, but within each scope are immutable.
[Bowling Ball Holder with Text](https://github.com/matthewcordaro/Bowling-Ball-Holder)
